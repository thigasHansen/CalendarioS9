// ====== CONFIG: set your Supabase URL and anon key ======
const SUPABASE_URL = "https://whrugfiojjbxkzjvtgjs.supabase.co"; // <-- replace
const SUPABASE_ANON_KEY = "sb_publishable_3qJoVWoF-Kfn1n2dAi0RgA_gqT-j5uN"; // <-- replace
